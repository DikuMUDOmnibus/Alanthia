...
const struct cmd_type cmd_table[] = {
    ...
    {"exits", do_exits, POS_RESTING, 0, LOG_NEVER, 1},
    {"get", do_get, POS_RESTING, 0, LOG_NORMAL, 1},
    {"group", do_group, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"guide", do_guide, POS_STANDING, L8, LOG_NORMAL, 1},
    {"hit", do_kill, POS_FIGHTING, 0, LOG_NORMAL, 0},
    {"inventory", do_inventory, POS_DEAD, 0, LOG_NEVER, 1}, 
    ...
    {"leader", do_leader, POS_RESTING, 0, LOG_ALWAYS, 1},
    {"member", do_member, POS_RESTING, 0, LOG_ALWAYS, 1},
    {"order", do_order, POS_RESTING, 0, LOG_NORMAL, 1},
    {"practice", do_practice, POS_SLEEPING, 0, LOG_NEVER, 1},
    {"preserve", do_preserve, POS_RESTING, 0, LOG_NEVER, 1},
    {"rest", do_rest, POS_SLEEPING, 0, LOG_NEVER, 1},
    {"repair", do_repair, POS_RESTING, 0, LOG_NORMAL, 1},
    {"sit", do_sit, POS_SLEEPING, 0, LOG_NEVER, 1},
    {"stand", do_stand, POS_SLEEPING, 0, LOG_NEVER, 1},
    {"tell", do_tell, POS_DEAD, 0, LOG_NORMAL, 1},
    {"unlock", do_unlock, POS_RESTING, 0, LOG_NORMAL, 1},
    {"wield", do_wear, POS_RESTING, 0, LOG_NORMAL, 1},
    {"balance", do_balance, POS_DEAD, 1, LOG_NORMAL, 1},
    {"cbalance", do_cbalance, POS_DEAD, 1, LOG_NORMAL, 1},
    {"deposit", do_deposit, POS_DEAD, 1, LOG_NORMAL, 1},
    {"cdeposit", do_cdeposit, POS_DEAD, 1, LOG_NORMAL, 1},
    {"withdraw", do_withdraw, POS_DEAD, 1, LOG_NORMAL, 1},
    {"cwithdraw", do_cwithdraw, POS_DEAD, 1, LOG_NORMAL, 1},
    ...
    {"who", do_who, POS_DEAD, 0, LOG_NEVER, 1},
     ...
     */
    {"astack", do_astack, POS_DEAD, 0, LOG_NORMAL, 0},
    {"alia", do_alia, POS_DEAD, 0, LOG_NORMAL, 0},
    {"alias", do_alias, POS_DEAD, 0, LOG_NEVER, 1},
    {"arena", do_arena, POS_DEAD, 0, LOG_NEVER, 1},
    {"autolist", do_autolist, POS_DEAD, 0, LOG_NEVER, 1},
    {"autoassist", do_autoassist, POS_DEAD, 0, LOG_NEVER, 1},
    {"autodamage", do_autodamage, POS_DEAD, 0, LOG_NEVER, 1},
    {"autodefense", do_autodefense, POS_DEAD, 0, LOG_NEVER, 1},
    {"autoexit", do_autoexit, POS_DEAD, 0, LOG_NEVER, 1},
    {"autogold", do_autogold, POS_DEAD, 0, LOG_NEVER, 1},
    {"autoloot", do_autoloot, POS_DEAD, 0, LOG_NEVER, 1},
    {"autosac", do_autosac, POS_DEAD, 0, LOG_NEVER, 1},
    {"autosplit", do_autosplit, POS_DEAD, 0, LOG_NEVER, 1},
    {"autotitle", do_autotitle, POS_DEAD, 0, LOG_NEVER, 1},
    {"brief", do_brief, POS_DEAD, 0, LOG_NEVER, 1},
    {"colour", do_colour, POS_DEAD, 0, LOG_NEVER, 1},
    {"color", do_colour, POS_DEAD, 0, LOG_NEVER, 0},
    {"combine", do_combine, POS_DEAD, 0, LOG_NEVER, 1},
    {"compact", do_compact, POS_DEAD, 0, LOG_NEVER, 1},
    {"description", do_description, POS_DEAD, 0, LOG_NEVER, 1},
    {"delet", do_delet, POS_DEAD, 0, LOG_ALWAYS, 0},
    {"delete", do_delete, POS_DEAD, 0, LOG_ALWAYS, 1},
    {"pkil", do_pkil, POS_DEAD, 0, LOG_NORMAL, 0},
    {"pkill", do_pkill, POS_STANDING, 0, LOG_NORMAL, 1},
    {"nofollow", do_nofollow, POS_DEAD, 0, LOG_NORMAL, 1},
    {"noloot", do_noloot, POS_DEAD, 0, LOG_NEVER, 1},
    {"nomiss", do_nomiss, POS_DEAD, 0, LOG_NEVER, 1},
    {"nosummon", do_nosummon, POS_DEAD, 0, LOG_NEVER, 1},
    ...
    {"unalias", do_unalias, POS_DEAD, 0, LOG_NEVER, 1},
    {"wimpy", do_wimpy, POS_DEAD, 0, LOG_NORMAL, 1},

    /*
     * Communication commands.
     */
    {"afk", do_afk, POS_SLEEPING, 0, LOG_NEVER, 1},
    {"announce", do_announce, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"answer", do_answer, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"argue", do_argue, POS_SLEEPING, 0, LOG_NORMAL, 1},
    ...
    {"gocial", do_gocial, POS_SLEEPING, 193, LOG_NORMAL, 1},
    {".", do_gossip, POS_SLEEPING, 0, LOG_NORMAL, 0},
    {"gossip", do_gossip, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"ooc", do_gossip, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"]", do_farspeak, POS_SLEEPING, 0, LOG_NORMAL, 0},
    {"farspeak", do_farspeak, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"fs", do_farspeak, POS_SLEEPING, 0, LOG_NORMAL, 0},
    {",", do_emote, POS_RESTING, 0, LOG_NORMAL, 0},
    {"gratz", do_gratz, POS_SLEEPING, 0, LOG_NORMAL, 1},
    ...
    {"qnote", do_qnote, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"rpnote", do_rpnote, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"pose", do_pose, POS_RESTING, 0, LOG_NORMAL, 1},
    {"qwest", do_qwest, POS_SLEEPING, 0, LOG_NORMAL, 1},
    ...
    {"rm", do_rm, POS_SLEEPING, L8, LOG_NORMAL, 1},
    {"cm", do_cm, POS_SLEEPING, L8, LOG_NORMAL, 1},
    {"say", do_say, POS_RESTING, 0, LOG_NORMAL, 1},
    {"'", do_say, POS_RESTING, 0, LOG_NORMAL, 0},
    {"shout", do_shout, POS_RESTING, 2, LOG_NORMAL, 1},
    {"swear", do_swear, POS_SLEEPING, 0, LOG_NORMAL, 1},
    ...
    {"quick poison", skill_quick_poison, POS_STANDING, 0, LOG_NORMAL, 1},
    {"feed", do_feed, POS_RESTING, 0, LOG_NORMAL, 1},
    {"fill", do_fill, POS_RESTING, 0, LOG_NORMAL, 1},
    {"fly", do_fly, POS_STANDING, 0, LOG_NORMAL, 1},
    ...
    {"sacrifice", do_sacrifice, POS_RESTING, 0, LOG_NEVER, 1},
    ...
    {"breathe", do_breathe, POS_RESTING, 0, LOG_NORMAL, 1},
    {"beer", do_beer, POS_RESTING, 0, LOG_NORMAL, 1},
    ...
    {"flee", do_flee, POS_RESTING, 0, LOG_NORMAL, 1},
    {"kick", do_kick, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"arial", do_arial, POS_FIGHTING, 0, LOG_NORMAL, 1},
    ...
    {"whirl", do_whirl, POS_FIGHTING, 0, LOG_NORMAL, 1},
    ...
    {"incognito", do_incognito, POS_DEAD, L8, LOG_NORMAL, 1},
    ...
    {"smote", do_smote, POS_DEAD, L8, LOG_NORMAL, 1},
    {"at", do_at, POS_DEAD, L8, LOG_NORMAL, 1},
    {"wizinvis", do_invis, POS_DEAD, L8, LOG_NORMAL, 1},
    {"zecho", do_zecho, POS_DEAD, L8, LOG_ALWAYS, 1},
    {"mimm", do_mimm, POS_DEAD, L8, LOG_NORMAL, 1},

	// L6
    {"clone", do_clone, POS_DEAD, L6, LOG_ALWAYS, 1},
    {"restore", do_restore, POS_DEAD, L6, LOG_ALWAYS, 1},
    {"morph", do_morph, POS_DEAD, L6, LOG_ALWAYS, 1},
    ...
    {"purge", do_purge, POS_DEAD, L6, LOG_ALWAYS, 1},
    ...
    {"rwhere", do_rwhere, POS_DEAD, L5, LOG_NORMAL, 1},
    ...
    {"mplist", do_mplist, POS_DEAD, L5, LOG_NEVER, 1},
    {"mpsave", do_mpsave, POS_DEAD, L5, LOG_NORMAL, 1},
    {"mpstat", do_mpstat, POS_DEAD, L5, LOG_NEVER, 1},
    {"oedit", do_oedit, POS_DEAD, L5, LOG_ALWAYS, 1},
    {"redit", do_redit, POS_DEAD, L5, LOG_ALWAYS, 1},
    {"resets", do_resets, POS_DEAD, L5, LOG_ALWAYS, 1},
    {"aedit", do_aedit, POS_DEAD, L5, LOG_ALWAYS, 1},
    {"asave", do_asave, POS_DEAD, L5, LOG_ALWAYS, 1},
    {"damtype", do_damtype, POS_DEAD, L5, LOG_NORMAL, 1 },
    {"edit", do_olc, POS_DEAD, L5, LOG_ALWAYS, 1},
    {"hedit", do_hedit, POS_DEAD, L5, LOG_ALWAYS, 1},
    {"raedit", do_raedit, POS_DEAD, L5, LOG_ALWAYS, 1},
    {"lload", do_lload, POS_DEAD, L5, LOG_NORMAL, 1},
    {"medit", do_medit, POS_DEAD, L5, LOG_ALWAYS, 1},
    {"genesi", do_genesi, POS_DEAD, L5, LOG_NORMAL, 0},
    {"genesis", do_genesis, POS_DEAD, L5, LOG_ALWAYS, 1},

    // L4
    {"bonus", do_bonus, POS_DEAD, L4, LOG_ALWAYS, 1},
    {"set", do_set, POS_DEAD, L4, LOG_ALWAYS, 1},
    {"flag", do_flag, POS_DEAD, L4, LOG_ALWAYS, 1},

	// L2
    {"sockets", do_sockets, POS_DEAD, L2, LOG_NORMAL, 1},
    {"wiznet", do_wiznet, POS_DEAD, L2, LOG_NORMAL, 1},
    {"guild", do_guild, POS_DEAD, L2, LOG_ALWAYS, 1},
    {"force", do_force, POS_DEAD, L2, LOG_ALWAYS, 1},

	// L1
    {"wrath", do_wrath, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"sla", do_sla, POS_DEAD, L1, LOG_NORMAL, 0},
    {"slay", do_slay, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"disconnect", do_disconnect, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"freeze", do_freeze, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"advance", do_advance, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"allow", do_allow, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"ban", do_ban, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"deny", do_deny, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"dump", do_dump, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"log", do_log, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"memory", do_memory, POS_DEAD, L1, LOG_NORMAL, 1},
    {"newlock", do_newlock, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"nochannels", do_nochannels, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"noemote", do_noemote, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"noshout", do_noshout, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"notell", do_notell, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"pardon", do_pardon, POS_DEAD, L1, LOG_ALWAYS, 1},
    ...
    {"retribution", do_retribution, POS_DEAD, L1, LOG_ALWAYS, 1},
    {"security", do_security, POS_DEAD, L1, LOG_ALWAYS, 1},
...
/*    { "rlook",          do_rlook,       POS_DEAD,    IM,  LOG_ALWAYS },
    { "rfind",          do_rfind,       POS_DEAD,    IM,  LOG_ALWAYS },
    { "rwhere",         do_rwhere,      POS_DEAD,    IM,  LOG_ALWAYS },
    { "rrandom",        do_rrandom,     POS_DEAD,    IM,  LOG_ALWAYS },
    { "rmob",           do_rmob,        POS_DEAD,    IM,  LOG_ALWAYS },
    { "rput",           do_rput,        POS_DEAD,    IM,  LOG_ALWAYS },
    { "rgive",          do_rgive,       POS_DEAD,    IM,  LOG_ALWAYS },
    { "rwear",          do_rwear,       POS_DEAD,    IM,  LOG_ALWAYS },
    { "rdrop",          do_rdrop,       POS_DEAD,    IM,  LOG_ALWAYS },
    { "rkill",          do_rkill,       POS_DEAD,    IM,  LOG_ALWAYS },
    { "rview",          do_rview,       POS_DEAD,    IM,  LOG_ALWAYS },
    { "rdoor",          do_rdoor,       POS_DEAD,    IM,  LOG_ALWAYS },
    { "findlock",       do_findlock,    POS_DEAD,    IM,  LOG_ALWAYS },
    { "freset",         do_freset,      POS_DEAD,    IM,  LOG_ALWAYS },
*/
