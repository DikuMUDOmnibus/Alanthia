...
DECLARE_DO_FUN( do_argue        	);
DECLARE_DO_FUN(	do_arial		);
DECLARE_DO_FUN( do_asave		);
DECLARE_DO_FUN( do_assassinate  	);
DECLARE_DO_FUN( do_astack		);
DECLARE_DO_FUN(	do_at			);
DECLARE_DO_FUN(	do_auction		);
DECLARE_DO_FUN( do_autoassist		);
DECLARE_DO_FUN( do_autodamage   	);
DECLARE_DO_FUN( do_autodefense  	);
...
DECLARE_DO_FUN( do_cwithdraw     );
DECLARE_DO_FUN( do_damtype		);
...
DECLARE_DO_FUN( do_low_heal		);
DECLARE_DO_FUN( do_medit		);
DECLARE_DO_FUN( do_member       );
DECLARE_DO_FUN(	do_memory		);
DECLARE_DO_FUN(	do_mfind		);
DECLARE_DO_FUN(	do_mimm			);
...
DECLARE_DO_FUN( skill_quick_poison	);
